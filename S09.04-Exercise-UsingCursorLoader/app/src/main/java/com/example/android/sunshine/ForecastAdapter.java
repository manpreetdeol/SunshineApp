...
//        forecastAdapterViewHolder.weatherSummary.setText(weatherForThisDay);
        ...
        int weather_id = mCursor.getInt(MainActivity.INDEX_WEATHER_CONDITION_ID);
        String description = SunshineWeatherUtils.getStringForWeatherCondition(mContext, weather_id);
        ...
        String highLowTemp = SunshineWeatherUtils.formatHighLows(mContext, highTemp, lowTemp);
