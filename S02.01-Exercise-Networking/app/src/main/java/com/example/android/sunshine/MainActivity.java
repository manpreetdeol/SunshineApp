...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadWeatherData() {
        ...
        URL finalUrl = NetworkUtils.buildUrl(SunshinePreferences.getPreferredWeatherLocation(this));

        new WeatherAsyncTask().execute(finalUrl);
    }
    ...
    class WeatherAsyncTask extends AsyncTask<URL, Void, String> {
        ...
        protected String doInBackground(URL... urls) {
            ...
            try {
                weatherResult = NetworkUtils.getResponseFromHttpUrl(urls[0]);
            } catch (IOException e) {
                e.printStackTrace();
            }
