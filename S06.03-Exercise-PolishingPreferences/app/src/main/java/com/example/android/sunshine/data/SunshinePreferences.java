...
public class SunshinePreferences {
    ...
    public static boolean isMetric(Context context) {
        ...
        String metricValue = sharedPreferences.getString(context.getString(R.string.pref_units_key), context.getString(R.string.pref_units_metric));

        if(metricValue.equals(context.getString(R.string.pref_units_metric))) {
            return true;
        }
        /** This will be implemented in a future lesson **/
        return false;
